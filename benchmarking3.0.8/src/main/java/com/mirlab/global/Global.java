...
public class Global {
	...
	public static int[] HOST_IP = { 10, 0, 0, 0 };
...
//	public static EthType ethType; 
	...
	public static int NUMBER_OF_TEST_FLOW = 0; 
	public static int GUARD_TIME = 0;
	...
	public static int[] distribudtedTool_PortList = { 12000, 12001 };
	...
	/************************************************* north bound  */
	public static NorthboundMetric northboundMetric;
	public static NorthboundMetric sendType;
	
	/** AsyncProactivePathProvisioning Time */
	
	public static ConcurrentHashMap<Integer, String> startTime = new ConcurrentHashMap<Integer,String>();
	public static ConcurrentHashMap<Integer, Long> lastTime = new ConcurrentHashMap<Integer,Long>();
	public static ConcurrentHashMap<Integer, String> avgTime = new ConcurrentHashMap<Integer,String>();
	
	/************************************************* sn bound  */
	public static SNboundMetric snboundMetric;
	public static NorthboundMetric northORwrap;
	
	//Proactive path 
	public static ConcurrentHashMap<String, Long> proStartTime = new ConcurrentHashMap<String, Long>();
	public static ConcurrentHashMap<String, Long> proLastTime = new ConcurrentHashMap<String, Long>();


	public static int countFlow = 0; 
