...
public class DistributedFrame {
	...
	private void initialize() {
		...
		lblDistributedBenchmarkConfiguration.setIcon(new ImageIcon(DistributedFrame.class.getResource("/com/alee/extended/filechooser/icons/settings.png")));
		...
		lblConnectionState.setIcon(new ImageIcon(DistributedFrame.class.getResource("/com/alee/examples/content/icons/presentation.png")));
		...
		table_1.setModel(new DefaultTableModel(
			new Object[][] {
				{"Topology Discovery Time", "ms", null, null, null, null},
			...
			new String[] {
				"Metric", "Unit", "Master Result", "Slave 1 Result", "Slave 2 Result", "Slave 3 Result"
			}
		));
