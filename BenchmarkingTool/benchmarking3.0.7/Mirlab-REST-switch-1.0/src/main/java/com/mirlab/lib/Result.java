...
public class Result {
	...
	public static void WR_ADD_RESULT(String str, int x, int y) {
	
		Main.gui.SN_RESULT_TABLE.getModel().setValueAt(str, x, y);
	
	}
	
	public static void N_ADD_RESULT(String str, int x, int y) {
		
		Main.gui.N_RESULT_TABLE.getModel().setValueAt(str, x, y);
