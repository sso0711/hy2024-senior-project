 ...
 */
public class SsyncProactiveProTime_test {
	...
	public static int checkLoop = 1;

	public static String onosIP = null;

	public SsyncProactiveProTime_test() {
...
//		String path = "http://192.168.1.114" + ":8181/onos/v1/flows";
		...
		String path = "http://" + onosIP + ":8181/onos/v1/flows";
		...
		if (responseCode == 200) {
			...
			System.out.println("########## flows lim lenth :: " + flowMaxNum);
			...
			if (Flows.length() == flowMaxNum) {
				...
				System.out.println("########## provisioning avg time : " + avgTime / flowNum);
...
//		String URL = "http://192.168.1.114:8181/onos/v1/flows/of%3A0000000000000002?appId=org.onosproject.testfwd";
		...
		post.addHeader("mirName", "gilho");
		post.setHeader("mirName2", "gilgil");
		...
		try {
			...
			int responseCode = statusLine.getStatusCode();
			//
			System.out.println("#####header   #"+String.valueOf(httpResponse3.headerIterator().toString()));
			//1 
			...
			System.out.println("#########parse size : " + responseString.length());
			System.out.println("############# getLastHeader "  + httpResponse3.getLastHeader(responseString));
			System.out.println("############# getFirstHeader "  + httpResponse3.getFirstHeader(responseString));
			System.out.println("############# getLastHeader "  + httpResponse3.getLastHeader("mirName"));
			System.out.println("############# getFirstHeader "  + httpResponse3.getFirstHeader("mirName"));
			System.out.println("############# getLastHeader "  + httpResponse3.getLastHeader("mirName2"));
			System.out.println("############# getFirstHeader "  + httpResponse3.getFirstHeader("mirName2"));
			System.out.println("#########getLocale  :" +httpResponse3.getLocale());
			StringEntity parseStringResponse = new StringEntity(httpResponse3.toString(),"UTF-8");
			System.out.println("333#   :P " + parseStringResponse);
			
		

	//2 
//			String responseString2 = new BasicResponseHandler().handleResponse(httpResponse3);
//			System.out.println("#########parse2 : "+responseString2 );
			
			HeaderIterator it = httpResponse3.headerIterator("mirName");
			System.out.println("## size it : " + it.toString());
//			
...
//			}
			...
			if (responseCode == 201) {
				...
				if (checkLoop > 1) {
					...
					if (checkLoop == flowNum) {

						System.out.println("");
						System.out.println("");
						System.out.println("");
						System.out.println("<<Mirlab - Benchmark>> : Experiment Result ::");
						System.out.println("########## provisioning avg time : " + avgTime / (flowNum - 1));
