...
public class temp {
	public static void main(String[] args) {
		...
		OFMessage ofpi1 = PacketMaker_NEW.MAKE_OPENFLOW_PACKET_IN(host1.getBelong2Port(), arpPacket1);
		...
		OFMessage ofpi2 = PacketMaker_NEW.MAKE_OPENFLOW_PACKET_IN(host2.getBelong2Port(), arpPacket2);
