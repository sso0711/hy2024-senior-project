...
public class CreateTopo {
	...
	public Node[] create_mininetTopoWith200hosts() {
		...
		// add nodes and hosts to linktable
		// LinkTable.Initialize(switch_count, host_count);
	...
	private Node[] create_ringTopo() {
		...
		System.out.println("portNum ： " + port1.getPortNum());
		System.out.println("distribudtedTool_IP1:" + distribudtedTool_IP1);
		System.out.println("distribudtedTool_Port1:" + Global.distribudtedTool_Port.get(distribudtedTool_IP1));
		System.out
				.println("distribudtedToolSever_Port1:" + Global.distribudtedToolSever_Port.get(distribudtedTool_IP1));

		Port port2 = nodes[Global.NUMBER_OF_TEST_SWITCH - 1].addPort();
		String distribudtedTool_IP2 = Global.distribudtedTool_IP.get(1);

		System.out.println("portNum ： " + port2.getPortNum());
		System.out.println("distribudtedTool_IP2:" + distribudtedTool_IP2);
		System.out.println("distribudtedTool_Port2:" + Global.distribudtedTool_Port.get(distribudtedTool_IP2));
		System.out
				.println("distribudtedToolSever_Port2:" + Global.distribudtedToolSever_Port.get(distribudtedTool_IP2));
