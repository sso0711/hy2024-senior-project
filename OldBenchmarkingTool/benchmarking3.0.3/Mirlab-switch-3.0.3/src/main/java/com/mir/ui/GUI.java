...
public class GUI {
	...
	public JProgressBar N_progressBar;
	...
	public JButton N_startButton;
	public JLabel N_benchmarkCondition;
	public JProgressBar N_progressBarTotal;
	...
	public DistributedFrame dr = new DistributedFrame();
	...
	public static void main(String args[]) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GUI window = new GUI();
					window.cf = new ConfigurationFrame();
					window.cf.frmConfiguration.setVisible(false);
...
//				Global.CONTROLLER_MODE = S_comboBoxControllerMode.getSelectedIndex();
				Global.conMode = ControllerMode.valueOf(S_comboBoxControllerMode.getSelectedItem().toString().toUpperCase());
...
//				Global.CONTROLLER_TYPE = S_comboBoxControllerType.getSelectedIndex();
				Global.conTroller = Controller.valueOf(S_comboBoxControllerType.getSelectedItem().toString().toUpperCase());
		...
		S_comboBoxControllerType.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				...
				Controller conValue = Controller.valueOf(S_comboBoxControllerType.getSelectedItem().toString().toUpperCase());
